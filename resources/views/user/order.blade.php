...
<div class="container">
    ...
    @if(Session()->has('removerOrder'))
     <p>{{ Session::get('removerOrder')}}</p>
    @endif
    <div class="row justify-content-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <form action="{{ route('order.remove', encrypt($order->id)) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-danger w-100">Remove Order</button>
                </form>
            </div>
        </div>
        @endforeach
